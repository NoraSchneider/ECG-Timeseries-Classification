...
"""
VGG-like architecture adapted from https://www.hindawi.com/journals/jhe/2021/7167891/
...
class DoubleConvCNN(BaseCNN):
    ...
    def model_builder(self) -> Model:
        ...
        model = Sequential()
        model.add(Conv1D(input_shape=(187, 1), filters=16, kernel_size=3, strides=1, padding="valid", activation=activations.relu))
